...
public class Commands implements TabExecutor
{
    ...
    public Commands( Main plugin )
    {
        ...
        this.registerSubCommand( new SubCommandTesttp( plugin, "testtp" ) );
        ...
        this.registerSubCommand( new SubCommandTargetPlayers( plugin, "targetplayers" ) );
        this.registerSubCommand( new SubCommandSetWinBlock( plugin, "setwinblock" ) );
        ...
        this.registerSubCommand( new SubCommandPlayersGames( plugin, "playersgames" ) );
        this.registerSubCommand( new SubCommandGameStats( plugin, "gamestats" ) );
